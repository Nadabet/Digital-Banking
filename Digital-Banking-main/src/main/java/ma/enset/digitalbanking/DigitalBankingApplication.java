...
public class DigitalBankingApplication { public static void main(String[] args) {
    ...
    CommandLineRunner start(CustomerRepository customerRepository,
        ...
        return args -> {
            ...
            customerRepository.findAll().forEach(cust->{
                ...
                currentAccount.setCustomer((Customer) cust);
                ...
                savingAccount.setCustomer((Customer) cust);
